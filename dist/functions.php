...
function swiftype_search_params_filter( $params ) {
  ...
  $params['search_fields[posts]'] = array( 'title^3', 'tags^2', 'author^2', 'body', 'excerpt', 'project_description', 'flex_text', 'troper_job', 'troper_bio' );
...
?>
  ...
  var swiftypeConfig = {
    ...
    searchFields: {'posts': ['title', 'tags', 'author', 'body', 'excerpt', 'project_description', 'flex_text', 'troper_job', 'troper_bio']}
  };
  </script>
<?php
}
